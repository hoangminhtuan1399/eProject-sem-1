...
function FeaturedAlbum($albums, $title): void
{
    ...
    <div class="row g-lg-4 g-2 d-flex mb-lg-4 mb-3">
        <?php
        foreach ($albums as $album) {
            ?>
            <div class="col-lg-3 col-4 featured-album__item-wrapper">
                <a href="album.php?id=<?php echo $album['album_id'] ?>"
                   class="d-flex flex-column text-decoration-none text-reset row-gap-1">
                    ...
                    <p class="mb-0" style="font-size: 0.9rem"><?php echo $album['name'] ?></p>
                </a>
            </div>
            <?php
        }
