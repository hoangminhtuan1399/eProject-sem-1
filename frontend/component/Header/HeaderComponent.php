...
function HeaderComponent()
{
                ...
                <div class="d-flex gap-2 flex-column flex-lg-row">
                    ...
                    if ($userSignedIn) {
                        ...
                        <div class="d-flex column-gap-2">
                            <p class="mb-0 d-flex align-items-center column-gap-1">Xin chào
                                <strong><?php echo $username ?></strong></p>
                            <button type="button" class="btn btn-link px-0 text-decoration-none" data-bs-toggle="modal"
                                    data-bs-target="#ModalSignOut">Đăng xuất
                            </button>
                                        ...
                                        <div class="modal-body">
                                            <div class="myform">
                                                ...
                                                <form id="sign-in-form" class="needs-validation" novalidate
                                                      action="handle-sign-in.php" method="POST">
                                                    <input type="hidden" name="currentPage"
                                                           value="<?php echo $currentPage ?>">
                                                    <div class="mb-3 mt-4">
                                                        <label for="signin-username" class="form-label">Tên đăng
                                                            nhập: </label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="signin-password" class="form-label">Mật
                                                            khẩu:</label>
                                        ...
                                        <div class="modal-body">
                                            <div class="myform">
                                                ...
                                                <form id="sign-up-form" class="needs-validation" novalidate
                                                      action="handle-sign-up.php" method="POST">
                                                    <input type="hidden" name="currentPage"
                                                           value="<?php echo $currentPage ?>">
                                                    <div class="mb-3 mt-2">
                                                    ...
                                                    <div class="mb-3 mt-4">
                                                        <label for="signup-username" class="form-label">Tên đăng
                                                            nhập: </label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="signup-password" class="form-label">Mật
                                                            khẩu:</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="signup-confirm-password" class="form-label">Xác nhận
                                                            mật
                                                            khẩu:</label>
                                                        <input type="password" name="confirm-password"
                                                               class="form-control" id="signup-confirm-password"
                                                               required>
                                                        <div class="invalid-feedback">
                                                            Mật khẩu không khớp
                                                        </div>
    ...
    if (isset($_SESSION['signIn'])) {
        ...
        if ($signInStatus === 'fail') {
            ?>
            <div id="signin-toast"
                 class="toast mt-2 position-absolute top-0 start-50 translate-middle-x text-bg-danger align-items-center"
            ...
            if ($signInStatus === 'success') {
                ?>
                <div id="signin-toast"
                     class="toast mt-2 position-absolute top-0 start-50 translate-middle-x text-bg-success align-items-center"
                     role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="2000">
                    <div class="d-flex">
                        <div class="toast-body">
