...
?>
    ...
    <nav class="navbar navbar-expand-sm header__navbar mb-4 px-3">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="d-flex flex-sm-row flex-column flex-shrink-0 align-items-stretch column-gap-3 search-submit">
                <form class="d-flex align-items-center column-gap-2" action="search.php" method="GET">
                    <input type="hidden" name="type" value="song">
                    <input name="search" class="form-control" type="text" placeholder="Tìm kiếm" aria-label="search" style="width: 360px;" id="icon-check" required>
                    <button class="btn btn-primary my-2 my-sm-0" id="search-button" type="submit" style="font-size: larger;">Tìm kiếm</button>
                </form>
