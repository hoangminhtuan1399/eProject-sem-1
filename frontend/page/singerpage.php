...
$songLimit = 8;
$songPage = $_GET['songPage'] ?? 1;
$songOffset = $songLimit * ($songPage - 1);
$songCount = $SongView->showSongCountBySingerId($singerId);
...
$albumOffset = $albumLimit * ($albumPage - 1);
            ...
            <div class="col-8">
                ...
                <div class="container">
                    <div class="d-flex flex-column">
                        <div class="d-flex">
                            ...
                            <div>
                                <p class="fs-7 mb-0">Năm sinh:
                                    <?php echo $singers['birth_year'] ?>
                                </p>
                                <p class="fs-7 mb-0">Giới tính:
                                    <?php echo $singers['gender'] ?>
                                </p>
                                <p class="fs-7 mb-0">Quốc gia:
                                    <?php echo $singers['nationality'] ?>
                                </p>
                                <p class="fs-7 mb-0">
                                    <?php echo $singers['description'] ?>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="d-flex column-gap-2">
                        ...
                        foreach ($AlbumViewSingerId as $album) {
                            ...
                            <a class="text-reset text-decoration-none" href="album.php?id=<?php echo $album['album_id'] ?>">
                                <img class="album-item-wrapper flex-shrink-0 object-fit-cover"
                                    src="<?php echo $album['image'] ?>">
                                <p class="mb-0">
                                    <?php echo $album['name'] ?>
                                </p>
                            </a>
                    ...
                    <nav class="mt-4 d-flex justify-content-center">
                        <ul class="pagination">
                            <li class="page-item <?php echo ($albumPage <= 1 ? "disabled" : "") ?>">
                                <a class="page-link"
                                    href="singerpage.php?id=<?php echo $singerId ?>&albumPage=<?php echo $albumPage - 1 ?>&songPage=<?php echo $songPage?>"
                                    aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </li>
                            <?php
                            for ($i = 1; $i <= $albumPageCount; $i++) {
                                ?>
                                <li class="page-item <?php echo ($i == $albumPage ? "active" : "") ?>"> <a class="page-link"
                                        href="singerpage.php?id=<?php echo $singerId ?>&albumPage=<?php echo $i ?>&songPage=<?php echo $songPage?>">
                                        <?php echo $i ?>
                                    </a></li>
                                <?php
                            }
                            ?>
                            <li class="page-item <?php echo ($albumPage >= $albumPageCount ? "disabled" : "") ?> ">
                                <a class="page-link" href="singerpage.php?id=<?php echo $singerId?>&albumPage=<?php echo $albumPage + 1?>&songPage=<?php echo $songPage?>" aria-label="Next">
                    ...
                    <?php foreach ($PictureSingers as $PictureSinger) {
                        ...
                        <div class="singerpage-img-container">
                            <a href="singerpage.php?id=<?php echo $PictureSinger['singer_id'] ?>"
                                ...
                                <img title="<?php echo $PictureSinger['name'] ?>" class="img-fluid singerpage-img"
                                    src="<?php echo $PictureSinger['image'] ?>">
                            </a>
                        </div>
                        <?php
                    } ?>
